...
import com.hyphenate.chatuidemo.ui.PublicWebviewActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (itemViewType) {
            case ITEM_VIEW_TYPE_URL:// 处理链接动态的链接内容和和图片
                ...
                holder.urlContentTv.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(mContext, PublicWebviewActivity.class);
                        it.putExtra("url", circleItem.getLinkUrl());
